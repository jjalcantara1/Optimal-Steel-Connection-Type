...
y_class = df["Optimal Connection Type (Encoded)"].values
y_reg = df[["Performance Score", "Safety Margin (%)", "Material Usage (kg)"]].values
...
print("✅ Model and scaler saved (multi_task_nn.keras, scaler.pkl)")
